	...
	<!-- --------------------------------------------------------------------------------------- -->
		<div id="interface">
			...
			<div id="Conteudo">
				<div align="center">
					<br/>
					<h2 align="center"> <font color="blue"> SAÍDAS </font></h2> 
					<br/> 
					<table cellpadding="0" border="1" width="80%" align="center">
					<tr>
						<form action="../controller/query_saida.php" method="post" name="form_saidas" align="center" onSubmit="return valida_dados(this)">
						<td	class="corpo" align="center" width="60%"> 
							<br/> 
							<label> <font color="336699">  Registrar Saída das Sacolas </label> &nbsp;
							<br/> <br/>
							...
							<input name="qtd" value="20" type="text" size="2" maxlength="2" onkeyup='if (isNaN(this.value)) {this.value = ""}'> &nbsp;
